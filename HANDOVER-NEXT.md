...
Date: 9 July 2026. Supersedes every earlier handover. Pair with the updated CONTEXT.md and the v2.7.4 zip (which contains the v2.7.2, v2.7.3 AND v2.7.4 changes; none was uploaded separately). Development moves to Claude Code after this deploy; CLAUDE.md at the repo root carries the standing rules there.

## 1. What to do now, in order

1. Upload the v2.7.4 zip contents to the repo root on GitHub. Deleted files: NONE. New file: CLAUDE.md.
...
3. Run CHECKLIST-V2_7_4.md. It covers all three undeployed rounds: full-width rails and ask picks (v2.7.4), no owned titles plus episode-focused rows (v2.7.3) and the v2.7.2 items (browse-movies landing, By show toggle, profile name).
